...
const PRODUCTS = {
  ...
  pump: {
    img: "images/products/hydraulic-pump.jpg",
    tag: "现货 · 进口液压柱塞泵",
    title: "HYDRAULIK 液压泵 R13.3A",
    desc: "HYDRAULIK 高压液压柱塞泵，最高工作压力 Fmax=200bar、排量 Vg=9.40cm²，铸铁机身坚固耐用，为各类液压系统提供稳定、可靠的高压动力输出。",
    brand: "HYDRAULIK",
    warranty: "1 年",
    stock: "现货 5 台",
    specs: [
    ...
    features: [
      "最高工作压力 200bar，高压动力输出稳定",
      "排量 9.40cm²，柱塞结构，容积效率高",
      "铸铁机身，坚固耐用，适配工业液压系统",
      "现货供应，质保 1 年，专业售后支持"
    ],
    app: "广泛应用于工业液压系统、机床设备、重工机械及自动化生产线的高压液压动力源，为液压执行机构提供可靠压力与流量，已配套中国航发南方工业有限公司等制造企业。"
  }
};
